...
public class Database{
  ...
  public void insertData(String name, String location, String photo, String description){
    try{
      ...
      String sql = "insert into travel_travel(name, location, photo, description) values (?,?,?,?)";
  ...
  public void editData(String id, String name, String location, String photo, String description){
    try{
      String sql = "update travel_travel set name = '" + name + "' , location = '" + location + "', description = '" + description +"', photo = '" + photo + "' where id = " + id;
  ...
  public void deleteData(String id){
    try{
      String sql = "delete from travel_travel where id = " + id + ";";
      int a = stmt.executeUpdate(sql);
    }catch(Exception ex){
      System.out.println(ex);
    }
